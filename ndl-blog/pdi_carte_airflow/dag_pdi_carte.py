...
with DAG('bash_curl_carte_pdi',
        ...
        curl_carte_pdi = BashOperator(task_id='curl_carte_pdi',
                                bash_command=f'bash /dags/scripts/pdi_carte_job.sh {BashPdiCarteJob['USERNAME']} {BashPdiCarteJob['PASSWORD']} {BashPdiCarteJob['HOSTNAME']} {BashPdiCarteJob['PORT']} {BashPdiCarteJob['JOB_PATH']} {BashPdiCarteJob['JOB_NAME']} {BashPdiCarteJob['LOG_LEVEL']} {BashPdiCarteJob['SLEEP_INTERVAL']} {BashPdiCarteJob['LOG_RETURN']} '
                               )
